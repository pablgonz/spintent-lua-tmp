...
% arara: move: { files: [ spintent-05-luamml-mathml.html ], target: 'spintent-05-mathml.html' }
\DocumentMetadata{
    lang=en-US,
    pdfversion=2.0,
    pdfstandard=ua-2,
...
\setenumext[keyans*]{columns=2,noitemsep}
\setenumextmeta[2]{myroman}{no-store, label=\Roman*., noitemsep}
\setenumextmeta[2]{myarabic}{no-store,list-offset=0.5cm,label=(\arabic*),noitemsep}
\begin{document}
